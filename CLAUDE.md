...
- Dingen die **wel** een (gratis) account van de gebruiker vereisen en dus niet door Claude zelf gezet kunnen worden — zie `GROWTH-IDEAS.md`: Google Search Console, Bing Webmaster Tools, GoatCounter (bezoekersstatistieken, wacht op site-code van de gebruiker).
