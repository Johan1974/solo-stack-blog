...
|---|---|---|---|
| LinkedIn (persoonlijk profiel) | Wordt opgezet (2026-09-05) | IFTTT (gratis): "New RSS feed item" → "Share an update" op LinkedIn, checkt `feed.xml` elk uur | Same-day te koppelen, geen goedkeuringstraject (persoonlijk profiel, geen Company Page). Gebruiker richt de IFTTT-applet zelf in (eigen login/OAuth). |
